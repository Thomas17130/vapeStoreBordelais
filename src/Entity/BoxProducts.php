...
#[ORM\Entity(repositoryClass: BoxProductsRepository::class)]
class BoxProducts
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\ManyToMany(targetEntity: Basket::class, mappedBy: 'boxProducts')]
    private $baskets;
